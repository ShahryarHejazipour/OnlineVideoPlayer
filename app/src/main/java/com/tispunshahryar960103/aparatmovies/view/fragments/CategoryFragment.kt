...
import com.tispunshahryar960103.aparatmovies.viewModel.remoteViewModels.CategoryViewModel
import com.tispunshahryar960103.aparatmovies.viewModel.remoteViewModels.CategoryViewModelFactory
...
class CategoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        categoryViewModel=ViewModelProvider(requireActivity(),categoryViewModelFactory).get(
